...
% plot detrended GDP
dates = 1994:1/4:2019.1/4; zerovec = zeros(size(yk));
figure
title('SKorea Detrended log(real GDP) 1994Q1-2019Q1')
plot(qk, yktilde,'b', qk, zerovec,'r')
datetick('x', 'yyyy-qq')

figure
title('Japan Detrended log(real GDP) 1994Q1-2019Q1')
plot(qj, yjtilde,'b', qj, zerovec,'r')
datetick('x', 'yyyy-qq')
